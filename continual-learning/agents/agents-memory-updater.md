...
3. Inspect only transcript files under `~/.vybe/projects/<workspace-slug>/agent-transcripts/` that are new or have newer mtimes than the index.
...
- Updated `AGENTS.md` and `.vybe/hooks/state/continual-learning-index.json` when needed
